...
class PengembalianController extends Controller
{
    ...
    public function process1 (Request $request){
        ...
        $pinjaman = Detail_peminjaman_sewa::join("inventaris", "inventaris.id", "=", "detail_peminjaman_sewa.id_inventaris" )
                    ...
                    ->get(['detail_peminjaman_sewa.*', 'inventaris.nama']);
                        ...
                        return view('staff/process_pengembalian', compact('pinjaman'), ['id' => $id]);
    }

    public function process_edit1 (Request $request){
        $id = $request->query('id');
        $idp = $request->query('idp');
        ...
        return view('staff/process_pengembalian_edit', compact('pinjaman'), ['id' => $id, 'idp' => $idp]);
    }
    ...
    public function update1(Request $request){
        ...
        $validated["keterangan"] = "";
        Detail_peminjaman_sewa::create($validated);
        return redirect()->route('/staff/pengembalian/list', ['id' => $id]);
     }


    public function update_detail1 (Request $request, Detail_peminjaman_sewa $detail_peminjaman_sewa){
        $id = $request->query('id');
        $idp = $request->query('idp');
        ...
        $detail_peminjaman_sewa->update($validated);
        return redirect()->route('/staff/pengembalian', ['id' => $id]);
    }
