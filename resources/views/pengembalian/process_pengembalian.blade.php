            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text">Form Pengembalian</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                                ...
                                <div class="container mt-5">
                                    ...
                                    <div class="mb-3">
                                        <select name="id_anggota" id="id_anggota" class="form-control">
                                            ...
                                            <option value="habis pakai">Baik</option></option>
                                            <option value="tidak habis pakai">Rusak</option>
                                            <option value="tidak habis pakai">Hilang</option>
                                        </select>
                                    </div>
                                    <div class="mb3">
